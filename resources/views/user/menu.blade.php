...
<section class="menu-section-area {{Auth::check() ? 'isLoginMenu' : '' }}">
    ...
    <nav class="navbar navbar-expand-lg" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="{{route('login')}}"><img src="{{is_null(allsetting()['logo']) || allsetting()['logo'] == '' ? asset(IMG_STATIC_PATH.'logo.png') : asset(IMG_PATH.allsetting()['logo'])}}" alt="{{__('NFT Art Sells')}}"></a>
                ...
                <div class="mobile-header-left">
                    <ul class="mobile-menu-logo">
                        <li>
                            <a href="{{route('login')}}">
                                <div class="logo">
                                    <img src="{{asset('assets/user/img/logo.png')}}" alt="{{__('NFT Art Sells')}}" />
                                </div>
                            </a>
                        </li>
                    </ul>
